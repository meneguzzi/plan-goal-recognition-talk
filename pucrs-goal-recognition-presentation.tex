...
\begin{frame}[c]{Automated Planning - Less boring}
	...
	\begin{columns}[t]
		\begin{column}{.45\textwidth}
			\begin{center}
				Domain Description\\
				\only<1>{
				\includegraphics[width=.9\textwidth]{fig/domain-example.pdf}}
				\only<2->{
				\includegraphics[width=.9\textwidth]{fig/dovetail.pdf}}
			\end{center}
		...
		\begin{column}{.23\textwidth}
			\begin{center}
				Initial State\\
				\includegraphics[width=.9\textwidth]{fig/initial-state.pdf}
			\end{center}
		\end{column}
	...
	\begin{block}{Solution}
		\begin{center}
			\only<1-2>{\includegraphics[width=.6\textwidth]{fig/plan-problem.pdf}}
			\only<3->{\includegraphics[width=.6\textwidth]{fig/plan-solution.pdf}}
		\end{center}
	\end{block}
\end{frame}
...
\begin{frame}[c]{Planning Heuristics}
	\begin{columns}[t]
		\begin{column}[t]{.45\textwidth}
			\begin{center}
				\only<1>{\includegraphics[width=.9\textwidth]{fig/hanoi.pdf}}
				\only<2>{\includegraphics[width=.9\textwidth]{fig/heuristic.pdf}}
			\end{center}
		\end{column}
		\begin{column}[t]{.55\textwidth}
			...
			\end{itemize}
			% \begin{block}{Modern Planners and Heuristics}
%
% 			\end{block}
		\end{column}
	\end{columns}
...
\begin{frame}[c]{Goal Recognition Problem - Less boring}
	\begin{block}{Goal/Plan Recognition problems have \only<1>{three}\only<2->{\textbf{four}} key ingredients}
	\centering
	\begin{columns}[t]
		\begin{column}{.45\textwidth}
			\begin{center}
				Domain Description\\
				\only<1>{
				\includegraphics[width=.8\textwidth]{fig/domain-example.pdf}}
				\only<2->{
				\includegraphics[width=.8\textwidth]{fig/dovetail.pdf}}
			\end{center}
		...
		\begin{column}{.24\textwidth}
			\begin{center}
				...
				\includegraphics[width=.9\textwidth]{fig/goal-state.pdf}}
				\only<2->{
				Goal \textbf{Hypotheses}\\
				\includegraphics[width=.4\textwidth]{fig/goal-state-1.pdf}%\\[.5em]
				\quad
				\includegraphics[width=.4\textwidth]{fig/goal-state-2.pdf}\\[.5em]
				\includegraphics[width=.4\textwidth]{fig/goal-state-3.pdf}
				}
	...
	\begin{columns}
		\begin{column}{.75\textwidth}
			\begin{center}
				\only<2->{\textbf{Observations}\\[.2em]}
				% \only<1>{\includegraphics[width=.6\textwidth]{fig/plan-problem.pdf}}
				\only<2>{\includegraphics[width=.9\textwidth]{fig/observations-1.pdf}}
				\only<3>{\includegraphics[width=.9\textwidth]{fig/observations-2.pdf}}
				\only<4>{\includegraphics[width=.9\textwidth]{fig/observations-3.pdf}}
				\only<5->{\includegraphics[width=.9\textwidth]{fig/observations-4.pdf}}
			\end{center}
		\end{column}
		\begin{column}{.3\textwidth}
			\begin{center}
				\only<5->{\textbf{Solution}\\[.2em]}
				\only<5>{\small Correct Goal\\
					\includegraphics[width=.4\textwidth]{fig/goal-state-1.pdf}}
				\only<6>{\small Probability Distribution\\
					\includegraphics[width=.2\textwidth]{fig/goal-state-1.pdf}=.8
					\includegraphics[width=.2\textwidth]{fig/goal-state-2.pdf}=.1
					\includegraphics[width=.2\textwidth]{fig/goal-state-3.pdf}=.1}
			\end{center}
		\end{column}
	\end{columns}
