	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			\begin{itemize}
				...
				\item<3-> Most computer vision datasets already contain \textbf{annotated semantic information} (and algorithms assume their existence):
				\begin{itemize}
					\item Labels for \textbf{objects} and \textbf{relations}
				\end{itemize}
				\item<3-> Why not use this semantic information to co-design GR domains around them?
			\end{itemize}
		\end{column}
		\begin{column}{.4\textwidth}
			\only<1-2>{\includegraphics[width=\textwidth]{fig/computer-vision-eggs.pdf}}
			\only<3->{\includegraphics[width=\textwidth]{fig/computer-vision-annotated.pdf}
			Relations:\\
			\footnotesize
